...
def main():
    ...
    if opt.model_dir:
        ...
        logging.info(f"Output results saved to: {saved_path}")
    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        for param_group in optimizer.param_groups:
            logging.info(f'Learning rate: {param_group["lr"]:.6f}')
        ...
        if epoch % hypes['train_params']['eval_freq'] == 0:
            ...
            logging.info(f'At epoch {epoch}, the validation loss is {valid_ave_loss:.6f}')
    ...
    logging.info('------------------------------------------------------------------------------------------------------------------------')
    logging.info(f'Checkpoints saved to {saved_path}')
    torch.cuda.empty_cache()
