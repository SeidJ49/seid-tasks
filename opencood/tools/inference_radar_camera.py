    ...
    for i, batch_data in tqdm(enumerate(data_loader)):
        with torch.no_grad():
            ...
            if opt.fusion_method == 'late':
                pred_box_tensor, pred_score, gt_box_tensor, output_dict = inference_utils.inference_late_fusion(batch_data, model,
                                                                                                                opencood_dataset)
                comm = 0
                ...
                pred_box_tensor, pred_score, gt_box_tensor = inference_utils.inference_intermediate_fusion(batch_data, model,
                                                                                                           opencood_dataset)
            ...
            if opt.save_npy:
                ...
                inference_utils.save_prediction_gt(pred_box_tensor, gt_box_tensor, batch_data['ego']['origin_radar'][0], i, npy_save_path)
