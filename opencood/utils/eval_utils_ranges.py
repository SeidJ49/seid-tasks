...
def eval_final_results(result_stat, save_path, global_sort_detections=False, eval_epoch=None, range=""):
    dump_dict = {}
    ...
    file_name = 'eval.yaml' if range == "" else f'{range}_eval.yaml'
    ...
    print('The range is %s, '
          ...
          'The Average Precision at IOU 0.7 is %.2f' % (range, ap_30, ap_50, ap_70))
