...
class RadarCameraIntermediateFusionDataset(torch.utils.data.Dataset):
    ...
    def reform_param(self, cav_content, ego_content, timestamp_cur, timestamp_delay, cur_ego_pose_flag):
        ...
        # CAV
        delay_cav_lidar_pose = delay_cav_params['lidar']['cords']
        cur_cav_lidar_pose = cur_cav_params['lidar']['cords']
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose, cav_id=None):
        ...
        if self.velocity_encoding_flag:
            ...
            # Lidar_pose
            lidar_transform = selected_cav_base['params']['lidar']['cords']  # [x, y, z, roll, yaw, pitch]
            ...
            selected_cav_base['radars_np'][0] = self.process_all_radar_velocity(selected_cav_base['radars_np'][0],selected_cav_base['params']['radar0']['cords'], lidar_velocity_xyz, lidar_transform)
            selected_cav_base['radars_np'][1] = self.process_all_radar_velocity(selected_cav_base['radars_np'][1],selected_cav_base['params']['radar1']['cords'], lidar_velocity_xyz, lidar_transform)
            selected_cav_base['radars_np'][2] = self.process_all_radar_velocity(selected_cav_base['radars_np'][2], selected_cav_base['params']['radar2']['cords'], lidar_velocity_xyz, lidar_transform)
            selected_cav_base['radars_np'][3] = self.process_all_radar_velocity(selected_cav_base['radars_np'][3], selected_cav_base['params']['radar3']['cords'], lidar_velocity_xyz, lidar_transform)
            selected_cav_base['radars_np'][4] = self.process_all_radar_velocity(selected_cav_base['radars_np'][4],selected_cav_base['params']['radar4']['cords'], lidar_velocity_xyz, lidar_transform)
            selected_cav_base['radars_np'][5] = self.process_all_radar_velocity(selected_cav_base['radars_np'][5], selected_cav_base['params']['radar5']['cords'], lidar_velocity_xyz, lidar_transform)
