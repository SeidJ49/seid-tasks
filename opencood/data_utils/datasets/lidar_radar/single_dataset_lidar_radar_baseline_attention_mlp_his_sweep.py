...
class SingleDatasetLidarRadarBaselineAttentionMlpHisSweep(Dataset):
    ...
    def reinitialize(self):
        ...
        for scene_token, samples in self.dataset_info_pkl.items():
            ...
            for sample_idx, sample in enumerate(samples):
                ...
                cav_entry['params']['timestamp'] = sample['timestamp']
    ...
    def retrieve_his_data(self, idx):
        ...
        for sensor_name in cav_content['radar_sensors']:
            ...
            ego_speed_xyz = np.array([cav_content['params']['ego_speed']['vx'],cav_content['params']['ego_speed']['vy'],cav_content['params']['ego_speed']['vz']])
            ...
            for his_cav_content in s['sweeps']:
                ...
                his_lidar_velocity_xyz = np.array([
                    his_cav_content['ego_motion_cabin']['vx'],
                ...
                his_pts = self.process_his_radar_velocity(
                    his_radar_np,
                    his_radar_transform,
                    his_lidar_velocity_xyz,
                    his_ref_vehicle_pose,
                    radar_transform,
                    t_ref,
                    t_his
                )
    ...
    def process_all_radar_velocity(self, radar_np, radar_transform, ego_speed_xyz, ref_vehicle_pose):
        l2r_transform = x1_to_x2(ref_vehicle_pose, radar_transform)
        l2r_rotation_matrix = l2r_transform[:3, :3]
        radar_velocity_xyz = np.dot(l2r_rotation_matrix, ego_speed_xyz)
    ...
    def process_his_radar_velocity(self, his_radar_np, his_radar_transform, his_lidar_velocity_xyz, his_lidar_transform, radar_transform, t_ref, t_his):
