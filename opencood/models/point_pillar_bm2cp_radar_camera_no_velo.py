...
class MultiModalFusion(nn.Module):
    ...
    def forward(self, img_voxel, pc_dict):
        ...
        fused_voxel = fused_voxel + pc_voxel * pc_mask * (1 - img_mask) + img_voxel * self.img_fusion(img_voxel, pc_voxel) * (
                    1 - pc_mask) * img_mask
...
class PointPillarBM2CPRadarCameraNoVelo(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarBM2CPRadarCameraNoVelo, self).__init__()
        # cuda选择
        ...
        self.pillar_vfe = PillarVFE(pc_args['pillar_vfe'], num_point_features=4, voxel_size=pc_args['voxel_size'],
