        ...
        if self.multi_scale:
            ...
            for i in range(self.num_levels):
                ...
                if i == 0:
                    ...
                    _, communication_masks, communication_rates = communication(batch_confidence_maps,
                                                                                batch_level_thres_map, record_len,
                                                                                pairwise_t_matrix)
            ...
            _, communication_masks, communication_rates = communication(batch_confidence_maps, batch_thres_map,
