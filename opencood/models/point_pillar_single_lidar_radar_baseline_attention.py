...
class PointPillarSingleLidarRadarBaselineAttention(nn.Module):
    def __init__(self, args):
        super(PointPillarSingleLidarRadarBaselineAttention, self).__init__()
        ...
        # --- RADAR ----------------------------------------------------------------------------------------------------
        self.radar_pillar_vfe = PillarVFEBaselineAttention(args['pillar_vfe'], num_point_features=4, voxel_size=args['voxel_size'], point_cloud_range=args['lidar_range'])
