...
YAMLS=(
  "$REPO_ROOT/opencood/hypes_yaml/WP1/pillarnet_single_lidar_baseline_wp1.yaml"
  "$REPO_ROOT/opencood/hypes_yaml/WP1/pillarnet_single_lidar_radar_baseline_wp1.yaml"
  "$REPO_ROOT/opencood/hypes_yaml/WP1/pillarnet_single_radar_baseline_wp1.yaml"
)
